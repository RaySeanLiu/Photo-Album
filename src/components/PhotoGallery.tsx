...
const PhotoGallery = () => {
  ...
  const photos: Photo[] = [
    ...
    { id: 3, beforeUrl: `${baseUrl}pexels-asadphoto-457882.jpg`, afterUrl: `${baseUrl}beach_photo_in_cancun.webp`, aspectRatio: 'square' },
    { id: 4, beforeUrl: `${baseUrl}restaurant.htm`, afterUrl: `${baseUrl}restaurant_in_cancun.webp`, aspectRatio: 'landscape' },
